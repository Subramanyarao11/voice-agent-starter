...
PHRASES: dict[str, str] = {
    ...
    "knowledge_unavailable": (
        "अभी मैं स्रोत दस्तावेज़ नहीं देख पा रहा हूँ। आप योजना का नाम बताइए या "
        "किसी योजना की खोज के लिए पूछिए, मैं फिर भी मदद कर सकता हूँ।"
    ),
    ...
    "need_more_details": (
        "मुझे {count} संबंधित विकल्प मिले हैं। पात्रता पक्की करने से पहले मुझे कुछ और जानकारी चाहिए।"
    ),
    "related_options": (
        "मुझे {count} संबंधित विकल्प मिले हैं, लेकिन आपकी दी हुई जानकारी से अभी किसी के लिए पात्रता पक्की नहीं है। "
        "हर विकल्प के साथ दिए कारण देखिए, या किसी योजना का नाम बताकर पूछिए।"
    ),
